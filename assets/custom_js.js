...
!(function (e, t) {
            ...
            return function (n) {
                var o = t.createElement("img"),
                    r = function (t) {
                        ...
                        n && (n.match(e) && (i = "w" == RegExp.$2 ? RegExp.$1 / RegExp.$3 : RegExp.$3 / RegExp.$1) && t.setAttribute("data-aspectratio", i), t.setAttribute(lazySizesConfig.srcsetAttr, n.replace(a, "")));
                    },
                    s = function (e) {
                        var t = e.target.parentNode;
                        t && "PICTURE" == t.nodeName && i.call(t.getElementsByTagName("source"), r), r(e.target);
                    },
                    l = function () {
                        o.currentSrc && t.removeEventListener("lazybeforeunveil", s);
                    };
                n[1] && (t.addEventListener("lazybeforeunveil", s), (o.onload = l), (o.onerror = l), (o.srcset = "data:,a 1w 1h"), o.complete && l());
            };
        })();
    if (
        ...
        (o.pf = function (t) {
            var i, o;
            if (!e.picturefill) for (i = 0, o = t.elements.length; o > i; i++) n(t.elements[i]);
        }),
            (n = (function () {
                var r = function (e, t) {
                        return e.w - t.w;
                    ...
                    c = (function () {
                        ...
                        return function (o) {
                            return (e = []), (o = o.trim()).replace(a, "").replace(t, n), e.length || !o || i.test(o) || e.push({ c: o, u: o, w: 99 }), e;
                        };
                    })(),
                    u = function () {
                        u.init ||
                    ...
                    d = function (t, n) {
                        ...
                        !s && n && (s = t._lazypolyfill ? t._lazypolyfill._set : t.getAttribute(o.srcAttr) || t.getAttribute("src")),
                            (t._lazypolyfill && t._lazypolyfill._set == s) ||
                                ((r = c(s || "")),
                                n && t.parentNode && ((r.isPicture = "PICTURE" == t.parentNode.nodeName.toUpperCase()), r.isPicture && e.matchMedia && (i.aC(t, "lazymatchmedia"), u())),
                                (r._set = s),
                    ...
                    p = function (e) {
                        ...
                        if ((d((a = e), !0), (c = a._lazypolyfill).isPicture))
                            for (n = 0, s = (t = e.parentNode.getElementsByTagName("source")).length; s > n; n++)
                                        ...
                                        (u = (function (e) {
                                            for (var t, i, n = e.length, o = e[n - 1], r = 0; n > r; r++)
                                                if ((((o = e[r]).d = o.w / e.w), o.d >= e.d)) {
                                                    !o.cached && (t = e[r - 1]) && t.d > e.d - 0.13 * Math.pow(e.d, 2.2) && ((i = Math.pow(t.d - 0.6, 1.6)), t.cached && (t.d += 0.15 * i), t.d + (o.d - e.d) * i > e.d && (o = t));
                                                    break;
                                                }
                                            return o;
                                        })(c.sort(r))),
    ...
    (function (e, t) {
        ...
        function n(t, i) {
            ...
            (r = function (e, i) {
                ...
                if (n) {
                    ...
                    s[e] = n;
                } else e in l && "function" != typeof l[e] ? (s[e] = l[e]) : i && "function" == typeof l[e] && (s[e] = l[e](t, n));
            }),
            l))
                r(n);
            return (
        ...
        function o(e, i, n) {
            ...
            if (e) {
                if ("container" === i.ratio) {
                    for (o = s.scrollWidth, r = s.scrollHeight; !((o && r) || s === t); ) (o = (s = s.parentNode).scrollWidth), (r = s.scrollHeight);
                    o && r && (i.ratio = r / o);
                }
                ((e = (function (e, t) {
                    var i = [];
                    return (
                        ...
                        t.widths.forEach(function (n) {
                            var o = t.widthmap[n] || n,
                                r = { u: e.replace(h, o).replace(f, t.ratio ? Math.round(n * t.ratio) : ""), w: n };
        ...
        function r(e, t) {
            var o = n(e, t);
            return l.modifyOptions.call(e, { target: e, details: o, detail: o }), i.fire(e, "lazyriasmodifyoptions", o), o;
        }
        function s(e) {
        ...
        !(function () {
            var t,
                n = { prefix: "", postfix: "", srcAttr: "data-src", absUrl: !1, modifyOptions: function () {}, widthmap: {}, ratio: !1 };
            for (t in ((a = (i && i.cfg) || e.lazySizesConfig) || ((a = {}), (e.lazySizesConfig = a)),
            a.supportsType ||
            ...
            "widths" in (l = a.rias) ||
                ((l.widths = []),
                (function (e) {
                    for (var t, i = 0; !t || 3e3 > t; ) (i += 5) > 30 && (i += 1), (t = 36 * i), e.push(t);
                })(l.widths)),
            n))
                t in l || (l[t] = n[t]);
        })(),
            addEventListener(
                ...
                function (e) {
                    ...
                    if (e.detail.instance == i && ((t = e.target), e.detail.dataAttr && !e.defaultPrevented && !l.disabled && (g = t.getAttribute(a.sizesAttr) || t.getAttribute("sizes")) && v.test(g))) {
                        if (((c = r(t, (n = s(t)))), (b = h.test(c.prefix) || h.test(c.postfix)), c.isPicture && (u = t.parentNode)))
                            for (f = 0, p = (d = u.getElementsByTagName("source")).length; p > f; f++) (b || h.test((m = s(d[f])))) && (o(m, c, d[f]), (C = !0));
                        b || h.test(n) ? (o(n, c, t), (C = !0)) : C && (((E = []).srcset = []), (E.isPicture = !0), Object.defineProperty(t, "_lazyrias", { value: E, writable: !0 })),
                            C && (w ? t.removeAttribute(a.srcAttr) : "auto" != g && ((y = { width: parseInt(g, 10) }), x({ target: t, detail: y })));
                    }
                },
                !0
            );
            ...
            var n = function (e, t) {
                ...
                s = function (t, i) {
                    ...
                    if ((u = t._lazyrias).isPicture && e.matchMedia)
                        for (a = 0, l = (s = t.parentNode.getElementsByTagName("source")).length; l > a; a++)
            ...
            if (t.getElementsByClassName) {
                var i,
                    ...
                    x = function (e, n, o, r, s) {
                        ...
                        return o || (o = {}), (o.instance = i), a.initCustomEvent(n, !r, !s, o), e.dispatchEvent(a), a;
                    },
                    C = function (t, i) {
                        var o;
                        !s && (o = e.picturefill || n.pf) ? o({ reevaluate: !0, elements: [t] }) : i && i.src && (t.src = i.src);
                    },
                    E = function (e, t) {
                    ...
                    z = (function () {
                        var e,
                            ...
                            a = function (n, o) {
                                e && !o ? n.apply(this, arguments) : (r.push(n), i || ((i = !0), (t.hidden ? u : d)(s)));
                            };
                    ...
                    _ = function (e) {
                        ...
                        return function (e) {
                            var n;
                            (e = !0 === e) && (s = 33), t || ((t = !0), (n = o - (r.now() - i)) < 0 && (n = 0), e || n < 9 ? l() : u(l, n));
                        };
                    },
                    A = function (e) {
                        var t,
                ...
                var k = (function () {
                        var s,
                            ...
                            B = -1,
                            H = function (e) {
                                q--, e && e.target && w(e.target, H), (!e || q < 0 || !e.target) && (q = 0);
                            },
                            Z = function (e, i) {
                                var n,
                                    r = e,
                                    s = "hidden" == E(t.body, "visibility") || "hidden" != E(e, "visibility");
                                for (T -= i, L += i, P -= i, M += i; s && (r = r.offsetParent) && r != t.body && r != o; )
                                    (s = (E(r, "opacity") || 1) > 0) && "visible" != E(r, "overflow") && ((n = r.getBoundingClientRect()), (s = M > n.left && P < n.right && L > n.top - 1 && T < n.bottom + 1));
                                return s;
                            },
                            X = function () {
                                var e,
                                ...
                                if ((p = n.loadMode) && q < 8 && (e = g.length)) {
                                    (r = 0),
                                        B++,
                                        null == O && ("expand" in n || (n.expand = o.clientHeight > 500 && o.clientWidth > 500 ? 500 : 370), (F = n.expand), (O = F * n.expFactor)),
                                        j < O && q < 1 && B > 2 && p > 2 && !t.hidden ? ((j = O), (B = 0)) : (j = p > 1 && B > 1 && q < 6 ? F : 0);
                                    for (; r < e; r++)
                                        if (g[r] && !g[r]._lazyRace)
                                            if (U)
                                                if (
                                                    (((m = g[r][l]("data-expand")) && (h = 1 * m)) || (h = j),
                                                    v !== h && ((S = innerWidth + h * N), (k = innerHeight + h), (f = -1 * h), (v = h)),
                                                    ...
                                                    (L = a.bottom) >= f &&
                                                        ...
                                                        (P = a.left) <= S &&
                                                        (L || M || P || T) &&
                                                        (n.loadHidden || "hidden" != E(g[r], "visibility")) &&
                                                        ((d && q < 3 && !m && (p < 3 || B < 4)) || Z(g[r], h)))
                                                ) {
                                                    if ((Q(g[r]), (u = !0), q > 9)) break;
                                                } else !u && d && !c && q < 4 && B < 4 && p > 2 && (s[0] || n.preloadAfterLoad) && (s[0] || (!m && (L || M || P || T || "auto" != g[r][l](n.sizesAttr)))) && (c = s[0] || g[r]);
                                            else Q(g[r]);
                                    c && !u && Q(c);
                                }
                            },
                            G = _(X),
                            K = function (e) {
                                y(e.target, n.loadedClass), b(e.target, n.loadingClass), w(e.target, $), x(e.target, "lazyloaded");
                            },
                            Y = D(K),
                            $ = function (e) {
                                Y({ target: e.target });
                            ...
                            J = D(function (e, t, i, o, r) {
                                ...
                                (p = x(e, "lazybeforeunveil", t)).defaultPrevented ||
                                    (o && (i ? y(e, n.autosizesClass) : e.setAttribute("sizes", o)),
                                    (a = e[l](n.srcsetAttr)),
                                    (s = e[l](n.srcAttr)),
                                    r && (d = (c = e.parentNode) && f.test(c.nodeName || "")),
                                    (m = t.firesLoad || ("src" in e && (a || s || d))),
                                    (p = { target: e }),
                                    m && (w(e, H, !0), clearTimeout(h), (h = u(H, 2500)), y(e, n.loadingClass), w(e, $, !0)),
                                    ...
                                    b(e, n.lazyClass),
                                    z(function () {
                                        (!m || (e.complete && e.naturalWidth > 1)) && (m ? H(p) : q--, K(p));
                                    }, !0);
                            }),
                            Q = function (e) {
                                var t,
                                    ...
                                    r = "auto" == o;
                                ((!r && d) || !i || (!e[l]("src") && !e.srcset) || e.complete || g(e, n.errorClass) || !g(e, n.lazyClass)) &&
                                    ((t = x(e, "lazyunveilread").detail), r && I.updateElem(e, !0, e.offsetWidth), (e._lazyRace = !0), q++, J(e, t, r, o, i));
                            },
                            ee = function () {
                                if (!d) {
                        ...
                        return {
                            _: function () {
                                (m = r.now()),
                                    ...
                                    c("scroll", G, !0),
                                    c("resize", G, !0),
                                    e.MutationObserver ? new MutationObserver(G).observe(o, { childList: !0, subtree: !0, attributes: !0 }) : (o[a]("DOMNodeInserted", G, !0), o[a]("DOMAttrModified", G, !0), setInterval(G, 999)),
                                    c("hashchange", G, !0),
                                    ["focus", "mouseover", "click", "load", "transitionend", "animationend", "webkitAnimationEnd"].forEach(function (e) {
                                        t[a](e, G, !0);
                                    }),
                                    /d$|^c/.test(t.readyState) ? ee() : (c("load", ee), t[a]("DOMContentLoaded", G), u(ee, 2e4)),
                    ...
                    I = (function () {
                        var e,
                            i = D(function (e, t, i, n) {
                                var o, r, s;
                                if (((e._lazysizesWidth = n), (n += "px"), e.setAttribute("sizes", n), f.test(t.nodeName || ""))) for (r = 0, s = (o = t.getElementsByTagName("source")).length; r < s; r++) o[r].setAttribute("sizes", n);
                                i.detail.dataAttr || C(e, i.detail);
                            }),
                            o = function (e, t, n) {
                                var o,
                                    r = e.parentNode;
                                r && ((n = S(e, r, n)), (o = x(e, "lazybeforesizes", { width: n, dataAttr: !!t })).defaultPrevented || ((n = o.detail.width) && n !== e._lazysizesWidth && i(e, r, o, n)));
                            },
                            r = A(function () {
                                var t,
                                    i = e.length;
                ...
                return (i = { cfg: n, autoSizer: I, loader: k, init: T, uP: C, aC: y, rC: b, hC: g, fire: x, gW: S, rAF: z });
            }
        })(e, e.document);
        ...
        return (function (e) {
            ...
            function (e, t, i) {
                ...
                var o =
                    ...
                    v = { offset: 120, delay: 0, easing: "ease", duration: 400, disable: !1, once: !1, startEvent: "DOMContentLoaded", disableMutationObserver: !1 },
                    g = function () {
                        ...
                        return (
                            ...
                            (function (e) {
                                ...
                                : (document.querySelector("body").setAttribute("data-aos-easing", v.easing),
                                  ...
                                  window.addEventListener("orientationchange", (0, a.default)(g, 50, !0)),
            ...
            function (e, t) {
                (function (t) {
                    ...
                    function i(e, t, i) {
                        ...
                        return (
                            (t = r(t) || 0),
                            n(i) && ((C = !!i.leading), (p = (E = "maxWait" in i) ? b(r(i.maxWait) || 0, t) : p), (S = "trailing" in i ? !!i.trailing : S)),
                            (d.cancel = function () {
                    ...
                    e.exports = function (e, t, o) {
                        var r = !0,
                            s = !0;
                        if ("function" != typeof e) throw new TypeError(a);
                        return n(o) && ((r = "leading" in o ? !!o.leading : r), (s = "trailing" in o ? !!o.trailing : s)), i(e, t, { leading: r, maxWait: t, trailing: s });
                    };
                }.call(
                    t,
                    (function () {
            ...
            function (e, t) {
                (function (t) {
                    ...
                    e.exports = function (e, t, n) {
                        ...
                        return (
                            (t = o(t) || 0),
                            i(n) && ((C = !!n.leading), (p = (E = "maxWait" in n) ? y(o(n.maxWait) || 0, t) : p), (S = "trailing" in n ? !!n.trailing : S)),
                            (d.cancel = function () {
                                void 0 !== v && clearTimeout(v), (x = 0), (h = g = f = v = void 0);
                            }),
                            (d.flush = function () {
                ...
                if ("undefined" != typeof document) {
                    ...
                    for (var u = document.cookie ? document.cookie.split("; ") : [], d = /(%[0-9A-Z]{2})+/g, h = 0; h < u.length; h++) {
                        ...
                        try {
                            ...
                            if (((p = i.read ? i.read(p, m) : i(p, m) || p.replace(d, decodeURIComponent)), this.json))
                                try {
                                    p = JSON.parse(p);
                                } catch (e) {}
                            if (t === m) {
            ...
            if (
                ((function () {
                    if (!r) {
                        ...
                        i.appendChild(t);
                        var a = n(t);
                        (o = 200 == Math.round(e(a.width))), (s.isBoxSizeOuter = o), i.removeChild(t);
                    }
                })(),
                ...
                if ("none" == l.display)
                    return (function () {
                        for (var e = { width: 0, height: 0, innerWidth: 0, innerHeight: 0, outerWidth: 0, outerHeight: 0 }, n = 0; n < i; n++) {
                            e[t[n]] = 0;
                        }
                        return e;
                    })();
                ...
                var E = e(l.height);
                return !1 !== E && (c.height = E + (x ? 0 : v + w)), (c.innerWidth = c.width - (m + b)), (c.innerHeight = c.height - (v + w)), (c.outerWidth = c.width + g), (c.outerHeight = c.height + y), c;
            }
        }
        return s;
    }),
    ...
    (function (e, t) {
        ...
        function u(e, t) {
            ...
            if (i) {
                ...
                (this.options = n.extend({}, this.constructor.defaults)), this.option(t), this._create();
            }
        }
        (u.defaults = {
            accessibility: !0,
        ...
        return (
            ...
            (d.destroy = function () {
                this.deactivate(), e.removeEventListener("resize", this), this.allOff(), this.emitEvent("destroy"), delete this.element.flickityGUID, delete c[this.guid];
            }),
            n.extend(d, s),
            (u.data = function (e) {
        ...
        return (
            ...
            (o._getClosestResting = function (e, t, i) {
                for (
                    ...
                    r(t, o) && ((n += i), (o = t), null !== (t = this.getSlideDistance(-e, n)));
    ...
    (function (e, t) {
        "function" == typeof define && define.amd
            ...
            : "object" == typeof module && module.exports
            ? (module.exports = t(e, require("./flickity"), require("unipointer"), require("fizzy-ui-utils")))
    ...
    (function (e, t) {
        "function" == typeof define && define.amd
            ? define("flickity/js/player", ["ev-emitter/ev-emitter", "fizzy-ui-utils/utils", "./flickity"], function (e, i, n) {
                  return t(e, i, n);
              })
            : "object" == typeof module && module.exports
    ...
    (function (e, t) {
        "function" == typeof define && define.amd
            ? define("flickity/js/index", ["./flickity", "./drag", "./prev-next-button", "./page-dots", "./player", "./add-remove-cell"], t)
            : "object" == typeof module && module.exports && (module.exports = t(require("./flickity"), require("./drag"), require("./prev-next-button"), require("./page-dots"), require("./player"), require("./add-remove-cell")));
    })(window, function (e) {
        return e;
    }),
    (function (e, t) {
        ...
        (o.positionSliderAtSelected = function () {
            ...
            (o.fadeSlides = function () {
                if (!(this.slides.length < 2)) {
                    ...
                    null != this.fadeHideIndex && this.fadeHideIndex != r && this.fadeHideIndex != e.a && (this.fadeHideIndex, e.b);
    ...
    (function (e, t) {
        ...
        return function (e, t, i, n) {
            var o = {
                ...
                detectFeatures: function () {
                    ...
                    for (var l, c, u = ["transform", "perspective", "animationName"], d = ["", "webkit", "Moz", "ms", "O"], h = 0; h < 4; h++) {
                        t = d[h];
                        for (var f = 0; f < 3; f++) (l = u[f]), (c = t + (t ? l.charAt(0).toUpperCase() + l.slice(1) : l)), !i[l] && c in e && (i[l] = c);
            ...
            var a,
                ...
                ke = function (e) {
                    te && (e && (v > r.currItem.fitRatio ? we || ($t(r.currItem, !1, !0), (we = !0)) : we && ($t(r.currItem), (we = !1))), Ae(te, de.x, de.y, v));
                },
                Ie = function (e) {
                ...
                Oe = null,
                Ne = function () {
                    Oe && (o.unbind(document, "mousemove", Ne), o.addClass(e, "pswp--has_mouse"), (s.mouseUsed = !0), ze("mouseUsed")),
                ...
                Ve = {
                    ...
                    init: function () {
                        if (!a && !l) {
                            ...
                            for ((N.animationName && N.transform && !n) || (s.showAnimationDuration = s.hideAnimationDuration = 0), i = 0; i < ye.length; i++) r["init" + ye[i]]();
                            ...
                            ze("firstUpdate"),
                                ...
                                s.modal && (ge ? (e.style.position = "fixed") : ((e.style.position = "absolute"), (e.style.top = o.getScrollY() + "px"))),
                    ...
                    destroy: function () {
                        ze("destroy"), Ot && clearTimeout(Ot), e.setAttribute("aria-hidden", "true"), (e.className = M), w && clearInterval(w), o.unbind(r.scrollWrap, p, r), o.unbind(window, "scroll", r), pt(), Ye(), (Ee = null);
                    },
                    panTo: function (e, t, i) {
                        i || (e > ee.min.x ? (e = ee.min.x) : e < ee.max.x && (e = ee.max.x), t > ee.min.y ? (t = ee.min.y) : t < ee.max.y && (t = ee.max.y)), (de.x = e), (de.y = t), ke();
                    },
                    ...
                    goTo: function (e) {
                        var t = (e = Ce(e)) - u;
                        (ve = t), (u = e), (r.currItem = Ut(u)), (fe -= t), Pe(me.x * fe), Ye(), (ie = !1), r.updateCurrItem();
                    },
                    next: function () {
                        r.goTo(u + 1);
                    },
                    ...
                    updateCurrZoomItem: function (e) {
                        ...
                        (ee = r.currItem.bounds), (g = v = r.currItem.initialZoomLevel), (de.x = ee.center.x), (de.y = ee.center.y), e && ze("afterChange");
                    },
                    ...
                    updateCurrItem: function (e) {
                        if (0 !== ve) {
                            var t,
                                i = Math.abs(ve);
                            if (!(e && i < 2)) {
                                (r.currItem = Ut(u)), (we = !1), ze("beforeChange", ve), i >= 3 && ((h += ve + (ve > 0 ? -3 : 3)), (i = 3));
                                for (var n = 0; n < i; n++)
                                    ve > 0
                                        ? ((t = C.shift()), (C[2] = t), h++, Te((h + 2) * me.x, t.el.style), r.setContent(t, u - i + n + 1 + 1))
                                        : ((t = C.pop()), C.unshift(t), h--, Te(h * me.x, t.el.style), r.setContent(t, u + i - n - 1 - 1));
                                if (te && 1 === Math.abs(ve)) {
                                    var o = Ut(E);
                    ...
                    updateSize: function (t) {
                        if (!ge && s.modal) {
                            var i = o.getScrollY();
                            if ((O !== i && ((e.style.top = i + "px"), (O = i)), !t && be.x === window.innerWidth && be.y === window.innerHeight)) return;
                            (be.x = window.innerWidth), (be.y = window.innerHeight), (e.style.height = be.y + "px");
                        }
                        if (((he.x = r.scrollWrap.clientWidth), (he.y = r.scrollWrap.clientHeight), He(), (me.x = he.x + Math.round(he.x * s.spacing)), (me.y = he.y), Pe(me.x * fe), ze("beforeResize"), void 0 !== h)) {
                        ...
                        (g = v = r.currItem.initialZoomLevel), (ee = r.currItem.bounds) && ((de.x = ee.center.x), (de.y = ee.center.y), ke(!0)), ze("resize");
                    },
                    zoomTo: function (e, t, i, n, r) {
                        t && ((g = v), (dt.x = Math.abs(t.x) - de.x), (dt.y = Math.abs(t.y) - de.y), Le(ue, de));
                        var s = Re(e, !1),
                            a = {};
                        ...
                        Fe(a);
                        var d = function (t) {
                            1 === t ? ((v = e), (de.x = a.x), (de.y = a.y)) : ((v = (e - l) * t + l), (de.x = (a.x - c) * t + c), (de.y = (a.y - u) * t + u)), r && r(t), ke(1 === t);
                        };
                ...
                gt = {},
                yt = function (e, t) {
                    return (gt.prevent = !vt(e.target, s.isClickableElement)), ze("preventDragEvent", e, t, gt), gt.prevent;
                },
                bt = function (e, t) {
                ...
                zt = function (e) {
                    ...
                    return (
                        k
                            ...
                            ? e.touches && e.touches.length > 0 && ((St[0] = bt(e.touches[0], Ct)), e.touches.length > 1 && (St[1] = bt(e.touches[1], Et)))
                            : ((Ct.x = e.pageX), (Ct.y = e.pageY), (Ct.id = ""), (St[0] = Ct)),
                        St
                    );
                },
                Dt = function (e, t) {
                        ...
                        (s.allowPanToNext || v === r.currItem.initialZoomLevel) &&
                            (te
                                ? "h" !== ne ||
                                  ...
                                  G ||
                                  (c
                                      ? (l > ee.min[e] && ((i = s.panEndFriction), ee.min[e] - l, (n = ee.min[e] - ue[e])), (n <= 0 || d < 0) && jt() > 1 ? ((a = u), d < 0 && u > ot.x && (a = ot.x)) : ee.min.x !== ee.max.x && (o = l))
                                      : (l < ee.max[e] && ((i = s.panEndFriction), l - ee.max[e], (n = ue[e] - ee.max[e])), (n <= 0 || d > 0) && jt() > 1 ? ((a = u), d > 0 && u < ot.x && (a = ot.x)) : ee.min.x !== ee.max.x && (o = l)))
                                : (a = u),
                            "x" === e))
                    )
                        return void 0 !== a && (Pe(a, !0), ($ = a !== ot.x)), ee.min.x !== ee.max.x && (void 0 !== o ? (de.x = o) : $ || (de.x += t.x * i)), void 0 !== a;
                        ...
                        if (Wt) e.preventDefault();
                            ...
                            (V = null),
                                ...
                                !J &&
                                    ...
                                    !ie &&
                                    !$ &&
                                    ((g = v), (G = !1), (J = X = !0), (ce.y = ce.x = 0), Le(ue, de), Le(Je, i[0]), Le(Qe, i[1]), wt(Je, Qe, ht), (dt.x = Math.abs(ht.x) - de.x), (dt.y = Math.abs(ht.y) - de.y), (Q = ft(Je, Qe)));
                        }
                },
                At = function (e) {
                ...
                kt = function () {
                    if (V) {
                        var e = V.length;
                        if (0 !== e)
                            if ((Le(Je, V[0]), (et.x = Je.x - tt.x), (et.y = Je.y - tt.y), J && e > 1)) {
                                if (
                                    ((tt.x = Je.x),
                                    (tt.y = Je.y),
                                    !et.x &&
                                ...
                                n < 0 && (n = 0), t, wt(Je, Qe, lt), (ce.x += lt.x - ht.x), (ce.y += lt.y - ht.y), Le(ht, lt), (de.x = Me("x", i)), (de.y = Me("y", i)), (q = i > v), (v = i), ke();
                            } else {
                                if (!ne) return;
                                if ((oe && ((oe = !1), Math.abs(et.x) >= 10 && (et.x -= V[0].x - it.x), Math.abs(et.y) >= 10 && (et.y -= V[0].y - it.y)), (tt.x = Je.x), (tt.y = Je.y), 0 === et.x && 0 === et.y)) return;
                ...
                It = function (e) {
                    ...
                    var c = -1;
                    if (
                        (0 === l && ((Z = !1), o.unbind(window, f, r), pt(), J ? (c = 0) : -1 !== ct && (c = De() - ct)),
                        (ct = 1 === l ? De() : -1),
                        (n = -1 !== c && c < 150 ? "zoom" : "swipe"),
                        J && l < 2 && ((J = !1), 1 === l && (n = "zoomPointerUp"), ze("zoomGestureEnded")),
                        (V = null),
                        K || G || ie || B)
                    )
                        if ((Ye(), j || (j = Tt()), j.calculateSwipeSpeed("x"), B)) {
                            if (xt() < s.verticalDragRange) r.close();
                                ...
                                $e("verticalDrag", 0, 1, 300, o.easing.cubic.out, function (e) {
                                    (de.y = (r.currItem.initialPosition.y - u) * e + u), _e((1 - d) * e + d), ke();
                                }),
                                    ze("onVerticalDrag", 1);
                            }
                        } else {
                    ...
                    var e,
                        ...
                        i = {
                            ...
                            calculateSwipeSpeed: function (n) {
                                rt.length > 1 ? ((e = De() - U + 50), (t = rt[rt.length - 2][n])) : ((e = De() - W), (t = it[n])),
                            ...
                            panAnimLoop: function () {
                                if (
                                    ...
                                    return (de.x = Math.round(de.x)), (de.y = Math.round(de.y)), ke(), void Ge("zoomPan");
                            },
                        };
                    return i;
                },
                ...
                Mt = function (e, t) {
                    ...
                    n && ((u += n) < 0 ? ((u = s.loop ? jt() - 1 : 0), (a = !0)) : u >= jt() && ((u = s.loop ? 0 : jt() - 1), (a = !0)), (a && !s.loop) || ((ve += n), (fe -= n), (i = !0)));
                    var d,
                        h = me.x * fe,
                        f = Math.abs(h - ut.x);
                    return (
                        i || h > ut.x == t.lastFlickSpeed.x > 0 ? ((d = Math.abs(t.lastFlickSpeed.x) > 0 ? f / Math.abs(t.lastFlickSpeed.x) : 333), (d = Math.min(d, 400)), (d = Math.max(d, 250))) : (d = 333),
                        at === u && (i = !1),
                        (ie = !0),
                        ze("mainScrollAnimStart"),
                        $e("mainScroll", ut.x, h, d, o.easing.cubic.out, Pe, function () {
                            Ye(), (ie = !1), (at = -1), (i || at !== u) && r.updateCurrItem(), ze("mainScrollAnimComplete");
                        }),
                ...
                publicMethods: {
                    initGestures: function () {
                        ...
                        (k = N.pointerEvent) && N.touch && (N.touch = !1),
                            ...
                            (m[D] = It),
                            _ && (m[_] = m[D]),
                            N.touch && ((p += " mousedown"), (f += " mousemove mouseup"), (m.mousedown = m[S]), (m.mousemove = m[z]), (m.mouseup = m[D])),
            ...
            var Ot,
                ...
                qt = function (t, i, n, a) {
                    var l;
                    Ot && clearTimeout(Ot), (Wt = !0), (Rt = !0), t.initialLayout ? ((l = t.initialLayout), (t.initialLayout = null)) : (l = s.getThumbBoundsFn && s.getThumbBoundsFn(u));
                    var d = n ? s.hideAnimationDuration : s.showAnimationDuration,
                        h = function () {
                            Ge("initialZoom"),
                                n ? (r.template.removeAttribute("style"), r.bg.removeAttribute("style")) : (_e(1), i && (i.style.display = "block"), o.addClass(e, "pswp--animated-in"), ze("initialZoom" + (n ? "OutEnd" : "InEnd"))),
                                a && a(),
                                (Wt = !1);
                        };
                    if (!d || !l || void 0 === l.x)
                    ...
                    (f = c),
                        ...
                        n || ((v = l.w / t.w), (de.x = l.x), (de.y = l.y - L), (r[p ? "template" : "bg"].style.opacity = 0.001), ke()),
                        Ke("initialZoom"),
                        n && !f && o.removeClass(e, "pswp--animated-in"),
                        n && !f && o.addClass(e, "123456"),
                        p &&
                            (n
                                ? o[(f ? "remove" : "add") + "Class"](e, "pswp--animate_opacity")
                                : setTimeout(function () {
                            ...
                            function () {
                                if ((ze("initialZoom" + (n ? "Out" : "In")), n)) {
                                    var i = l.w / t.w,
                                        ...
                                        a = se,
                                        c = function (t) {
                                            1 === t ? ((v = i), (de.x = l.x), (de.y = l.y - O)) : ((v = (i - s) * t + s), (de.x = (l.x - r.x) * t + r.x), (de.y = (l.y - O - r.y) * t + r.y)),
                                                ke(),
                                                p ? (e.style.opacity = 1 - t) : _e(a - t * a);
                                        };
                                    f ? $e("initialZoom", 0, 1, d, o.easing.cubic.out, c, h) : (c(1), (Ot = setTimeout(h, d + 20)));
                                } else (v = t.initialZoomLevel), Le(de, t.initialPosition), ke(), _e(1), p ? (e.style.opacity = 1) : _e(1), (Ot = setTimeout(h, d + 20));
                            },
                            n ? 25 : 90
                        ));
                },
                ...
                Xt = function (e, t, i) {
                    if (e.src && !e.loadError) {
                        var n = !i;
                        if ((n && (e.vGap || (e.vGap = { top: 0, bottom: 0 }), ze("parseVerticalMargin", e)), (Bt.x = t.x), (Bt.y = t.y - e.vGap.top - e.vGap.bottom), n)) {
                            var o = Bt.x / e.w,
                                r = Bt.y / e.h;
                            e.fitRatio = o < r ? o : r;
                            var a = s.scaleMode;
            ...
            xe("Controller", {
                publicMethods: {
                    lazyLoadItem: function (e) {
                        e = Ce(e);
                        var t = Ut(e);
                        t && ((!t.loaded && !t.loading) || x) && (ze("gettingData", e, t), t.src && Kt(t));
                    },
                        ...
                        o.extend(s, Zt, !0),
                            ...
                            Se("destroy", function () {
                                for (var e, t = 0; t < Nt.length; t++)
                                    (e = Nt[t]).container && (e.container = null), e.placeholder && (e.placeholder = null), e.img && (e.img = null), e.preloader && (e.preloader = null), e.loadError && (e.loaded = e.loadError = !1);
                                Ht = null;
                            });
                    },
                    ...
                    setContent: function (e, t) {
                        ...
                        if (l) {
                            ...
                            if ((!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : (c.innerHTML = l.html)), Yt(l), Xt(l, he), !l.src || l.loadError || l.loaded))
                                l.src && !l.loadError && (((n = o.createEl("pswp__img", "img")).style.opacity = 1), (n.src = l.src), $t(l, n), Gt(0, l, c, n));
                            else {
                                if (
                                    ((l.loadComplete = function (i) {
                                        if (a) {
                                            if (e && e.index === t) {
                                                if (Yt(i, !0)) return (i.loadComplete = i.img = null), Xt(i, he), Ie(i), void (e.index === u && r.updateCurrZoomItem());
                                                i.imageAppended
                                                    ? !Wt && i.placeholder && ((i.placeholder.style.display = "none"), (i.placeholder = null))
                                                    : N.transform && (ie || Wt)
                                                    ? Ht.push({ item: i, baseDiv: c, img: i.img, index: t, holder: e, clearPlaceholder: !0 })
                                                    : Gt(0, i, c, i.img, 0, !0);
                                            }
                                            (i.loadComplete = null), (i.img = null), ze("imageLoadComplete", t, i);
                                        }
                                    }),
                                    ...
                                    l.msrc && (h.src = l.msrc), $t(l, h), c.appendChild(h), (l.placeholder = h);
                                }
                                l.loading || Kt(l), r.allowProgressiveImg() && (!Rt && N.transform ? Ht.push({ item: l, baseDiv: c, img: l.img, index: t, holder: e }) : Gt(0, l, c, l.img, 0, !0));
                            }
                            Rt || t !== u ? Ie(l) : ((te = c.style), qt(l, n || l.img)), (e.el.innerHTML = ""), e.el.appendChild(c);
                        } else e.el.innerHTML = "";
                    },
            ...
            xe("Tap", {
                publicMethods: {
                    ...
                    onTapRelease: function (e, t) {
                        ...
                        if (t && !K && !X && !Xe) {
                            var r = t;
                            if (Jt && (clearTimeout(Jt), (Jt = null), (i = r), (n = ei), Math.abs(i.x - n.x) < 25 && Math.abs(i.y - n.y) < 25)) return void ze("doubleTap", r);
                ...
                xe("DesktopZoom", {
                    publicMethods: {
                        ...
                        handleMouseWheel: function (e) {
                            if (v <= r.currItem.fitRatio) return s.modal && (!s.closeOnScroll || Xe || Z ? e.preventDefault() : A && Math.abs(e.deltaY) > 2 && ((c = !0), r.close())), !0;
        ...
        return function (e, t) {
            var i,
                ...
                z = function (e) {
                    ...
                    for (var i, n, o = (e.target || e.srcElement).getAttribute("class") || "", r = 0; r < W.length; r++) (i = W[r]).onTap && o.indexOf("pswp__" + i.name) > -1 && (i.onTap(), (n = !0));
                    if (n) {
                    ...
                    return (
                        ...
                        !(
                            ...
                            (!i.hasAttribute("download") &&
                                (window.open(i.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), E || I(), 1))
                        )
                    );
                },
                P = function () {
            ...
            (w.init = function () {
                t.extend(e.options, S, !0),
                    ...
                    (function () {
                        ...
                        d("onVerticalDrag", function (e) {
                            C && e < 0.95 ? w.hideControls() : !C && e >= 0.95 && w.showControls();
                        }),
                            d("onPinchClose", function (t) {
                                C && t < 0.9 ? (w.hideControls(), (e = !0)) : e && !C && t > 0.9 && w.showControls();
                            }),
                    ...
                    d("bindEvents", function () {
                        t.bind(n, "pswpTap click", z), t.bind(e.scrollWrap, "pswpTap", w.onGlobalTap), e.likelyTouchDevice || t.bind(e.scrollWrap, "mouseover", w.onMouseOver);
                    }),
                                ...
                                if (n)
                                    for (var r = n.length, s = 0; s < r; s++) {
                                        ...
                                        for (var a = 0; a < W.length; a++)
                                            (o = W[a]), i.indexOf("pswp__" + o.name) > -1 && (v[o.option] ? (t.removeClass(e, "pswp__element--disabled"), o.onInit && o.onInit(e)) : t.addClass(e, "pswp__element--disabled"));
                                    }
                            };
                        r(n.children);
                ...
                (w.update = function () {
                    C && e.currItem ? (w.updateIndexIndicator(), v.captionEl && (v.addCaptionHTMLFn(e.currItem, o), _(o, "caption--empty", !e.currItem.title)), (x = !0)) : (x = !1), E || I(), A();
                }),
                ...
                (w.onGlobalTap = function (i) {
                    ...
                    if (!g)
                        ...
                        } else if ((v.tapToToggleControls && (C ? w.hideControls() : w.showControls()), v.tapToClose && (t.hasClass(n, "pswp__img") || M(n)))) return void e.close();
                }),
